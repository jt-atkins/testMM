      ...
      *                                                                *
      * JIRA 345678US  to add client's policy count to response        *
      *                                                                *
      ******************************************************************
      ...
      * Host variables for input to DB2 integer types
       01  DB2-IN-INTEGERS.
           ...
           03 DB2-CUSTOMERPOLICY-COUNT PIC S9(9) COMP.                  345678US
      ...
      *----------------------------------------------------------------*
       ...
       GET-CUSTOMER-INFO.
           ...
           Evaluate SQLCODE
             When 0
               MOVE '00' TO CA-RETURN-CODE
               PERFORM  GET-CUSTOMER-POLICY-COUNT                       345678US
             When 100
       ...
       GET-CUSTOMER-POLICY-COUNT.                                       345678US
                                                                        345678US
           EXEC SQL                                                     345678US
               SELECT COUNT(POLICYNUMBER)                               345678US
               INTO  :DB2-CUSTOMERPOLICY-COUNT                          345678US
               FROM POLICY                                              345678US
               WHERE CUSTOMERNUMBER = :DB2-CUSTOMERNUMBER-INT           345678US
               GROUP BY CUSTOMERNUMBER                                  345678US
           END-EXEC.                                                    345678US
                                                                        345678US
           Evaluate SQLCODE                                             345678US
             When 0                                                     345678US
               MOVE DB2-CUSTOMERPOLICY-COUNT TO CA-NUM-POLICIES         345678US
             When 100                                                   345678US
               MOVE 999                 TO CA-NUM-POLICIES              345678US
             When Other                                                 345678US
               MOVE '97' TO CA-RETURN-CODE                              345678US
               PERFORM WRITE-ERROR-MESSAGE                              345678US
               EXEC CICS RETURN END-EXEC                                345678US
           END-Evaluate.                                                345678US
                                                                        345678US
           EXIT.                                                        345678US
